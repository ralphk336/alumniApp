...
@Component({
  selector: 'app-alumnus-sidebar-mobile',
  templateUrl: './alumnus-sidebar-mobile.component.html',
  styleUrls: ['./alumnus-sidebar-mobile.component.css']
})
export class AlumnusSidebarMobileComponent implements OnInit{
